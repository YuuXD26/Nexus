...
const redeemCoupon = (couponCode, userNumber) => {
    ...
    if (validCoupons.includes(couponCode)) {
      // Kupon benar
      const existingUser = premiumData.users.find(user => user.number === userNumber);
                ...
                arxzy.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: 'Script Free',
                            body: `SCRIPT BOT ${namabot} Ada Di Youtube @ItsBayy`,
            ...
            */
            ...
            case 'ytmp3': {
                ...
                await arxzy.sendMessage(m.chat, {
                    ...
                    mimetype: 'audio/mp3',
                    fileName: "Downloader Ytmp3 By ItsBayy.mp3",
                    caption: ytmp4p,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
